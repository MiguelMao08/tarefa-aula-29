...
function setup() {
  ...
  leftWall = new Base(200, height / 2 + 50, 400, 100, "#8d6e63", true);
  rightWall = new Base(width - 200, height / 2 + 50, 400, 100, "#8d6e63", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(20, { x: width / 2 - 425, y: height / 2 + 10 });
  ...
  for (var i = 0; i <= 8; i++) {
    var x = random(width / 2 - 400, width / 2 + 200);
    var y = random(-10, 10);
